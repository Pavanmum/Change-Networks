...
import { AddProductData } from "../../../store/api/Admin/priceList.js";
...
const AddStock = ({ setShowAddStock,setHandleReload }) => {
  ...
  const [selectedStocks, setSelectedStocks] = useState("In Stock");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const AddStock = {
        ...
        price_level_1: priceLevel1,
        price_level_2: priceLevel2,
        price_level_3: priceLevel3,
        price_level_4: priceLevel4,
        price_level_5: priceLevel5,
        price_level_6: priceLevel6,
        qty: quantity,
        stock_status: selectedStocks,
        condition_status: selectedConditions,
        remark: remark,
        created_by : userDetial.data.user_id || userDetial.data.email
      };
                      ...
                      <div className="row mb-2">
                        ...
                        <div className="col-sm-8">
                          <input
                            ...
                            name="series"
                            required
                            onChange={(e) => setSeriesState(e.target.value)}
                          />
                        </div>
                      </div>
                      <div className="row mb-2">
